                                    ...
                                    <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a href=http://dasbogas.trplpa2.com/dashboard>Beranda</a>
                                            </li>
                                            <li class="breadcrumb-item">
                                                <a href=http://dasbogas.trplpa2.com/daftarproduk>Daftar Produk</a>
                                            </li>
                                        ...
                                        <div class="card-body">
                                            <form action="" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="hidden" name="id_produk" value="<?= $produk1["id_produk"]; ?>">
                                                        <input type="hidden" name="gambarLama" value="<?= $produk1["gambar_produk"]; ?>">
                                                        <input type="text" class="form-control" id="nama_produk" name="nama_produk" value="<?= $produk1["nama_produk"]; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-select form-control " aria-label="Default select example" id="tipe_produk" name="tipe_produk" autofocus>
                                                            <option value="<?= $produk1["tipe_produk"]; ?>">Makanan</option>
                                                            <option value="<?= $produk1["tipe_produk"]; ?>">Minuman</option>
                                                            <option value="<?= $produk1["tipe_produk"]; ?>">Topping</option>
                                                            <option value="<?= $produk1["tipe_produk"]; ?>">Snack</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="hargatipea" class="col-sm-2 col-form-label">Deskripsi</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control " id="deskripsi" name="deskripsi" value="<?= $produk1["deskripsi"]; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <input style="max-height:150px" type="file" class="form-control  " id="gambar_produk" name="gambar_produk">
                                                    </div>
                                                </div>
