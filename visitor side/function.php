...
$produk = query("SELECT * FROM produk WHERE tipe_produk = 'Minuman'");
...
function tambah($data)
{
    ...
    $query = "INSERT INTO produk
                VALUES
            ('$id_produk', '$nama_produk','$tipe_produk', '$harga_produk','$gambar_produk')
        ";
            ...
            <header>
                <div class="content-wrapper">
                    ...
                    <div class="link-icons">
                        <a href="keranjang.php" data-bs-toggle="modal" data-bs-target="#exampleModal">
